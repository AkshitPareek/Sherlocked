...
<html lang="en">
  <head>
    ...
    <title>Sherlocked | DIGIT'18</title>
  ...
  <body class="text-center">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      ...
      <div class="jumbotron">
        <h1 class="rules-heading">Rules & Regulations</h1>
        </p>
              ...
              Hints will be posted from time to time on the Hints section of the hunt.<br>
      ...
      <footer class="mastfoot mt-auto">
        <div class="inner" >
              <div class="byline"  >
              <p>Designed by <a href="https://facebook.com/vatafakN">Akshit Pareek</a>.</p> 
              </div>
        </div>
      </footer>
    </div>
